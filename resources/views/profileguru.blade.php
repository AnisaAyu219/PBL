...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-success elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Moch. Syafa Rendy Ardana Aditya</a>
        </div>
      </div>
  ...
  <path d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm-5 6s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zM11 3.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5zm.5 2.5a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1h-4zm2 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2zm0 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2z"/>
                ...
                <h3 class="card-title" style="position: absolute; left: 60px; top: 15px;">PROFILE GURU PEMBIMBING</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <table class="table">
  <tbody>
    ...
    <tr>
      ...
      <td>Moch. Syafa Rendy Ardana Aditya</td>
      
    </tr>
    <tr>
      <th scope="row">No Telp</th>
      <td colspan="2">08525877655</td>
    </tr>
  </tbody>
</table>
            </div>
