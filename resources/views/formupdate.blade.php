...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'http://localhost:8000/api/detail_jurnal/{id}',
               ...
               >
                ...
                ?>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="tanggal" value="<?php echo $user->tanggal?>">
                  </div>
                  <div class="form-group">
                    <label for="kegiatan">Kegiatan</label>
                    <textarea type="text" class="form-control" rows="3" name="kegiatan" value="<?php echo $user->kegiatan?>"></textarea>
