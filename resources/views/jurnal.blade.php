...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'http://localhost:8000/api/detail_jurnal',
...
<div class="wrapper">
  ...
  <path d="M4 .5a.5.5 0 0 0-1 0V1H2a2 2 0 0 0-2 2v1h16V3a2 2 0 0 0-2-2h-1V.5a.5.5 0 0 0-1 0V1H4V.5zM16 14V5H0v9a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2zm-5.146-5.146-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 0 1 .708-.708L7.5 10.793l2.646-2.647a.5.5 0 0 1 .708.708z"/>
             ...
             <li class="nav-item">
            <a href="../forms/jurnal.html" class="nav-link active">
  ...
  <path d="M8.5 2.687c.654-.689 1.782-.886 3.112-.752 1.234.124 2.503.523 3.388.893v9.923c-.918-.35-2.107-.692-3.287-.81-1.094-.111-2.278-.039-3.213.492V2.687zM8 1.783C7.015.936 5.587.81 4.287.94c-1.514.153-3.042.672-3.994 1.105A.5.5 0 0 0 0 2.5v11a.5.5 0 0 0 .707.455c.882-.4 2.303-.881 3.68-1.02 1.409-.142 2.59.087 3.223.877a.5.5 0 0 0 .78 0c.633-.79 1.814-1.019 3.222-.877 1.378.139 2.8.62 3.681 1.02A.5.5 0 0 0 16 13.5v-11a.5.5 0 0 0-.293-.455c-.952-.433-2.48-.952-3.994-1.105C10.413.809 8.985.936 8 1.783z"/>
                ...
                <h3 class="card-title" style="position: absolute; left: 60px; top: 15px;">DATA JURNAL</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
        ...
        <tr>
            ...
            <td><a href="formupdate.blade.php?id=<?php echo $user->id;?>">Edit</a></td>
		<td><a href="proses/delete_jurnal.php?id=<?php echo $user->id; ?>"> Delete
                    </a>
                </td>
        </tr>
        <?php }; ?>
               ...
               >
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" rows="3" name="kegiatan" placeholder="Masukkan Kegiatan"></textarea>
                  </div>
                  <div class="form-group">
